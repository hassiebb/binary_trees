 ...
 * @parentPo: Pointer to the parent node
...
/* tasks */
binary_tree_t *binary_tree_node(binary_tree_t *parentPo, int value);
...
void binary_tree_preorder(const binary_tree_t *tree, void (*funPo)(int));
